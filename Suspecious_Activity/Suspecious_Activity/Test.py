...
def MAIL(d_msg):
    ...
    msg = MIMEMultipart()
    fromaddr = 'iswatipatra@gmail.com'
    toaddr = 'iswatipatra@gmail.com'
    msg['From'] = fromaddr
    msg['To'] = toaddr
    password = 'helloswati732902'
...
def main():
    ...
    cap = cv2.VideoCapture("C:/Users/swati/Desktop/Suspecious_Activity/Suspecious_Activity/Bruce_Lee_Trim.mp4")
    while True:
        msg = MIMEMultipart()
        ...
        cv2.imwrite('C:/Users/swati/Desktop/Suspecious_Activity/Suspecious_Activity/img1.jpg',frame)
        fileName = 'C:/Users/swati/Desktop/Suspecious_Activity/Suspecious_Activity/img1.jpg'
...
#                                       filetypes=[("all files", "*.*")])
        ...
        mob = cv2.imread('C:/Users/swati/Desktop/Suspecious_Activity/Suspecious_Activity/img1.jpg')
